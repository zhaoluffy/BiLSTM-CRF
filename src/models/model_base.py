...
class ModelBase(Configurable):
    ...
    def _create_optimizer(self):
        ...
        with tf.variable_scope("train_step"):
            ...
            if self.params["optimizer.name"] == 'adam':
                optimizer = tf.train.AdamOptimizer(self.params["optimizer.learning_rate"])
            elif self.params["optimizer.name"] == 'adagrad':
                optimizer = tf.train.AdagradOptimizer(self.params["optimizer.learning_rate"])
            elif self.params["optimizer.name"] == 'sgd':
                optimizer = tf.train.GradientDescentOptimizer(self.params["optimizer.learning_rate"])
            elif self.params["optimizer.name"] == 'rmsprop':
                optimizer = tf.train.RMSPropOptimizer(self.params["optimizer.learning_rate"])
            else:
    ...
    def _build_train_op(self, loss):
        ...
        learning_rate_decay_fn = model_helper.create_learning_rate_decay_fn(
